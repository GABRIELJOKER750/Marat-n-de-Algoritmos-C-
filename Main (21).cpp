...
int main() {
    ...
    double suma = 0, nota;
    double notaMin = std::numeric_limits<double>::max();
    double notaMax = std::numeric_limits<double>::lowest();
    ...
    std::cout << "Nota mínima: " << notaMin << std::endl;
    std::cout << "Nota máxima: " << notaMax << std::endl;
